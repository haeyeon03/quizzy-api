...
public class QuizController {
    ...
    public ResponseEntity<ApiResponse<List<QuizAnswerResponseDto>>> getAnswerListByQuizQuestionId(@PathVariable Long quizId, @PathVariable Long quizQuestionId) {
     ...
     */
    @PutMapping("/{quizId}")
    public ResponseEntity<ApiResponse<Long>> modifyQuiz(@PathVariable Long quizId, @RequestBody QuizRequestDto request) {
    ...
    public ResponseEntity<ApiResponse<Integer>> addRank(@PathVariable Long quizId, @AuthenticationPrincipal ChallengerAuthDto my, @RequestBody RankRequestDto request) {
